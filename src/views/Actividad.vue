...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema: '¡A exportar se ha dicho!',
      titulo: 'Cuestionario',
      introduccion:
        '<b> Objetivo:</b> verificar la comprensión de las variables comerciales, logísticas y operativas que se deben dominar para exportar con éxito en el marco del APC Colombia con Estados Unidos.',
